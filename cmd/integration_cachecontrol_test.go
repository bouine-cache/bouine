...
func TestCacheW3CStandards(t *testing.T) {
	...
	tests := []struct {
		...
		// 	expectedFirstRes:  http.Response{StatusCode: 200, Header: http.Header{"Cache-Control": []string{"max-age=99999999999"}, "X-Cache": []string{middleware.StatusMiss}}},
		// 	expectedSecondRes: http.Response{StatusCode: 200, Header: http.Header{"Cache-Control": []string{"max-age=99999999999"}, "X-Cache": []string{middleware.StatusHit}}},
		// },
		// TODO: doesn\'t work as expected, need official cache or core middleware changes
		// {
		...
		// 	expectedFirstRes:  http.Response{StatusCode: 200, Header: http.Header{"Cache-Control": []string{"max-age=3600"}, "Age": []string{"7200"}, "X-Cache": []string{middleware.StatusMiss}}},
		// 	expectedSecondRes: http.Response{StatusCode: 200, Header: http.Header{"Cache-Control": []string{"max-age=3600"}, "Age": []string{"7200"}, "X-Cache": []string{middleware.StatusMiss}}},
		// },
		{
		...
		// 	expectedFirstRes:  http.Response{StatusCode: 200, Header: http.Header{"Cache-Control": []string{"max-age=3600, s-maxage=1"}, "X-Cache": []string{middleware.StatusMiss}}},
		// 	expectedSecondRes: http.Response{StatusCode: 200, Header: http.Header{"Cache-Control": []string{"max-age=3600, s-maxage=1"}, "X-Cache": []string{middleware.StatusMiss}}},
		// },
		// TODO: doesn\'t work as expected, need official cache or core middleware changes
		// {
		...
		// 	expectedFirstRes:  http.Response{StatusCode: 200, Header: http.Header{"Cache-Control": []string{"s-maxage=1, max-age=3600"}, "X-Cache": []string{middleware.StatusMiss}}},
		// 	expectedSecondRes: http.Response{StatusCode: 200, Header: http.Header{"Cache-Control": []string{"s-maxage=1, max-age=3600"}, "X-Cache": []string{middleware.StatusMiss}}},
		// },
		// TODO: doesn\'t work as expected, need official cache or core middleware changes
		// {
		...
		// 	expectedFirstRes:  http.Response{StatusCode: 200, Header: http.Header{"Cache-Control": []string{"max-age=1, s-maxage=3600"}, "X-Cache": []string{middleware.StatusMiss}}},
		// 	expectedSecondRes: http.Response{StatusCode: 200, Header: http.Header{"Cache-Control": []string{"max-age=1, s-maxage=3600"}, "X-Cache": []string{middleware.StatusHit}}},
		// },
		// TODO: doesn\'t work as expected, need official cache or core middleware changes
		// {
