...
func buildObject(key api.Key, r *http.Request, res fetchResult, negativeTTL, defaultTTL, overrideTTL time.Duration, defaultSWR, defaultSIE time.Duration, jitterPct int, policy *KeyPolicy) *api.Object {
	now := time.Now()
