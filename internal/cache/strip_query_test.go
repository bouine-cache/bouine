...
func TestBuildKey_StripQueryParams(t *testing.T) {
	t.Parallel()
	policy := NewKeyPolicy(map[string]bool{"utm_source": true, "fbclid": true}, nil, nil, nil, false, false, nil, false)
...
func TestBuildKey_StripQueryParams_AllStripped(t *testing.T) {
	t.Parallel()
	policy := NewKeyPolicy(map[string]bool{"a": true, "b": true}, nil, nil, nil, false, false, nil, false)
...
func TestBuildKey_StripQueryParams_StripsSingleParam(t *testing.T) {
	t.Parallel()
	policy := NewKeyPolicy(map[string]bool{"utm_source": true}, nil, nil, nil, false, false, nil, false)
